---
name: persona
description: Use when the user wants to create an AI influencer persona, virtual influencer, branded character, social-media persona, pet character (default = anthropomorphic humanoid pet — fluffy biped in cute clothes; real-form four-legged pet is opt-in), anime character, 3D-animated character, or any single-subject content character — from a brief or a reference image. Includes optional reel.
---
